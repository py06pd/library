...
class UserAuthenticatorTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->client = new UserAuthenticator(
            "s3cr3t",
            $this->mockEm,
    ...
    public function givenAddSessionSucceedsWhenOnAuthenticationSuccessCalledThenRedirectResponseReturned()
    {
        ...
        $cookie = new Cookie('library', "test", 123, '/', "test.com", true);
        $this->mockCookieService->expects($this->once())
            ->method('create')
            ->with('123|1533334331|304465058d0089b10b4e1bf35f074d6c13da94bc676ea979bf2900f72ef1531f', 1564870331)
            ->willReturn($cookie);
